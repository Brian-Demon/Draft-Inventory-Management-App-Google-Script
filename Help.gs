...
function BHBMenuHelp(){
  var ui = SpreadsheetApp.getUi();
  var response = ui.alert('Beerhead Bar & Eatery'
                          + '\r\n\r\nBeerhead Menu Help'
                          ...
                          + '\r\n\r\n\r\nCreated by: Brian Matejka (Beerhead Schaumburg, IL)',
  ui.ButtonSet.OK);
}
...
function NewInventoryHelp(){
  ...
  var response = ui.alert('Beerhead Bar & Eatery'
                          ...
                          + '\r\n2) Go to the menu bar: Beerhead Menu->Start New Inventory->Yes'
